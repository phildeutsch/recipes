...
function debounce(i, n, t) {
	...
	(-1 < navigator.platform.indexOf("Win") ? $(".ps") : $(window)).scroll(function() {
		50 < $(this).scrollTop() ? $navbar_minimize_fixed.css("opacity", "1") : $navbar_minimize_fixed.css("opacity", "0")
...
var blackDashboard = {
	...
	initMinimizeSidebar: function() {
		0 != $(".sidebar-mini").length && (sidebar_mini_active = !0), $(".minimize-sidebar").click(function() {
			1 == sidebar_mini_active ? ($body.removeClass("sidebar-mini"), sidebar_mini_active = !1) : ($body.addClass("sidebar-mini"), sidebar_mini_active = !0);
